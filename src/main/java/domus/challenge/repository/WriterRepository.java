/*
 * @(#WriterRepository.java 05/10/2025
...
import domus.challenge.entity.WriterEntity;


/**
 *
 *  <p>The class domus.challenge.repository.WriterRepository is a repository interface that extends JpaRepository</p>
 *
